...
<div class="bg-hard text-white min-h-full md:grid md:grid-cols-[15%,auto]">
    ...
    <section class={`w-full flex flex-row items-center gap-3 py-3 px-5 absolute top-0 z-10 ${scrollPosition > 50 ? "bg-soft" : "bg-transparent"} transition-all ease-in-out duration-300`}>
        <Sheet.Root>
            <Sheet.Trigger>
